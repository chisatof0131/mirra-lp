    ...
    <section id="download" className="relative isolate overflow-hidden bg-ink py-28 text-cream md:py-40">
      ...
      <div className="relative mx-auto flex max-w-[1100px] flex-col items-center px-6 text-center md:px-14">
        ...
        <p className="mt-10 max-w-[36rem] text-[15px] leading-[1.9] text-cream/65">
          今日から、あなたの美容習慣を変える。
          <br />
          Mirra Mirra は、iPhone・Android でご利用いただけます。
        </p>
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            href="#"
            className="inline-flex items-center gap-2 rounded-full border border-cream/20 bg-cream/5 px-7 py-4 text-[13px] tracking-[0.1em] text-cream transition hover:border-cream/40 hover:bg-cream/10"
          >
            <PlayGlyph />
            Google Play
          </a>
